...
This page demonstrates the reStructuredText live preview extension. Edit this
file in VS Code and watch the preview panel update in near real-time.
...
#. highlighted 
   ...
   - paragraph 
    ...
    .. mark::
       ...
       the world is not all sunshine and rainbow.
...
:mark:`not real purple should apply to the text here due to escape should work \<purple\>`
...
checking for fast rendering...still fast. yes indeed. 
:style:`fast as i type. <bold italic mono bg=yellow underline=green strike=blue font=Georgia>`

The rendering is still very fast even with all the profiling of new code.

.. style:: bold color=yellow underline=red
