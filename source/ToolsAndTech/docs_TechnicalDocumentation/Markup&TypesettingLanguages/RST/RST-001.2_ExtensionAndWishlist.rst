...
A good test is typing under a drawio diagram, the image rendered by 
drawio is still steady and not causing any disturbance to the diagram
as the document is re-rendered.

I like how fast this first version is.
