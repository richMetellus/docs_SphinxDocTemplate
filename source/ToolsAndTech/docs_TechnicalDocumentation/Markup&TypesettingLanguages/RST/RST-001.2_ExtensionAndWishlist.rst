...
Typing under drawio diagram is causing the page to flicker with this new 
set of change

I like how fast this first version is. Typing on this paragraph also cause 
the preview to flicker.
