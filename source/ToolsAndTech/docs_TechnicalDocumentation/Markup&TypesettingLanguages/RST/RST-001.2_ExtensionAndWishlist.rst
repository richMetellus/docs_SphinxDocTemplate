...
fast as I type. <bold italic mono bg=yellow underline=green strike=blue font=Colibri>` Regular
text after that.
...
.. style::
   ...
   working ~normally~. :strike:`A strike text no color specified`. 
   :strike:`strike with yellow strike <yellow>`
   Even if the paragraph span many lines or is a multi paragraph document, then 
   we can view the document.
